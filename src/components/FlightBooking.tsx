            ...
            <div className="bg-slate-100 p-4 rounded-lg border border-slate-200">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">{flight.departure.city} to {flight.arrival.city}</p>
                    </div>
                </div>
      ...
      case 4: // Confirmation
        ...
        return (
          <div className="text-center">
            ...
            <p className="mt-2 text-slate-600">Your flight to {flight.arrival.city} is booked. A confirmation has been sent to your email.</p>
