...
const WeatherCard: React.FC<{ dayForecast: DailyForecast }> = (props: { dayForecast: DailyForecast }) => {
...
const WeatherDisplay: React.FC<WeatherDisplayProps> = ({ forecast }: WeatherDisplayProps) => {
  return (
