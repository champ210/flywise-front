...
const TravelBuddy: React.FC<TravelBuddyProps> = ({ userProfile, onSaveTrip, savedTrips, isOffline, onFindFlights }) => {
    ...
    <>
      ...
      <div className="p-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8">
            {jointPlan && !isLoading && <ItineraryDisplay plan={jointPlan} onSaveTrip={onSaveTrip} isOffline={isOffline} onFindFlights={onFindFlights} />}
          </div>
