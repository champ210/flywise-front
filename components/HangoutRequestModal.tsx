    ...
    const fetchIcebreaker = async () => {
        ...
        try {
            ...
            const mockUserProfile: UserProfile = {
                ...
                favoriteDestinations: ['Japan', 'Italy'], 
                // FIX: Add interests and paymentMethods to mock user profile to align with the updated UserProfile type and improve AI prompt context.
                interests: ['Hiking', 'Local Food', 'Photography'], 
                budget: { flightMaxPrice: 1000, hotelMaxPrice: 200, carMaxPrice: 50},
                paymentMethods: []
            };
