...
const ALL_BADGES: Badge[] = [
  ...
  { id: 'foodie-explorer', name: 'Foodie Explorer', description: 'Order from 3 different local restaurants via Super Services.', icon: 'food' },
  { id: 'local-rider', name: 'Local Rider', description: 'Take 5 rides to explore the city via Super Services.', icon: 'car' },
