...
interface ItineraryPlannerProps {
  ...
  onPlannerDataHandled: () => void;
}

const ItineraryPlanner: React.FC<ItineraryPlannerProps> = ({ onSaveTrip, isOffline, onFindFlights, initialData, onPlannerDataHandled }) => {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      onPlannerDataHandled(); // Signal that data has been consumed
    }
  }, [initialData, onPlannerDataHandled]);
      ...
      <div className="p-4">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8">
              ...
              {plan && !isLoading && (
                <>
                  <ItineraryDisplay plan={plan} onSaveTrip={onSaveTrip} isOffline={isOffline} onFindFlights={onFindFlights} />
