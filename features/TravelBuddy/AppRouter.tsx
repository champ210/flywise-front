...
const FlightTracker = React.lazy(() => import('@/features/FlightTracker'));
...
const GroupPlanning = React.lazy(() => import('@/features/GroupPlanning'));
const Wandergram = React.lazy(() => import('@/features/Wandergram/Wandergram'));
const TravelBuddy = React.lazy(() => import('./TravelBuddy'));
const MeetupEvents = React.lazy(() => import('@/features/Events/MeetupEvents'));
const Wallet = React.lazy(() => import('@/features/Wallet'));
